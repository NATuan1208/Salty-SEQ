...
from backend.spm_explainer import match_patterns, build_spm_sequence_string
...
def api_predict(req: PredictRequest) -> dict:
    ...
    spm_sequence = build_spm_sequence_string(req.station_id, req.date, lookback=3)
    ...
    return {
        ...
        "confidence": confidence,
        "threshold": 0.30,
        "risk_thresholds": {"warning": 0.30, "danger": 0.50},
        "matched_patterns": matched_patterns,
        "spm_sequence": spm_sequence,
