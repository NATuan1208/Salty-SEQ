    ...
    return (
      <div className="gauge-wrap">
        <svg width={W} height={H + 22} viewBox={`0 0 ${W} ${H + 22}`} style={{ overflow:'visible' }}>
          ...
          <path d={arc(0.5, 29.5)} fill="none" stroke="#0FA860" strokeWidth={SW - 6} strokeOpacity=".42" strokeLinecap="butt"/>
          <path d={arc(30.5, 49.5)} fill="none" stroke="#C48020" strokeWidth={SW - 6} strokeOpacity=".50" strokeLinecap="butt"/>
          <path d={arc(50.5, 99.5)} fill="none" stroke="#C82020" strokeWidth={SW - 6} strokeOpacity=".35" strokeLinecap="butt"/>

          {(([ix, iy], [ox, oy]) =>
            <line x1={ix} y1={iy} x2={ox} y2={oy}
              stroke="var(--ink-3)" strokeWidth="1.8" strokeDasharray="3 2" strokeLinecap="round"/>
          )(pt(30, R - SW / 2 + 1), pt(30, R + SW / 2 + 10))}
          ...
          {(([lx, ly]) =>
            <text x={lx} y={ly} textAnchor="middle" dominantBaseline="middle" fontSize="9" fontFamily="JetBrains Mono, monospace" fill="var(--ink-4)">30</text>
          )(pt(30, R + SW / 2 + 19))}
          {(([lx, ly]) =>
          ...
          <text x={CX - 78} y={CY + 18} textAnchor="middle" fontSize="8" fontFamily="Nunito, sans-serif" fontWeight="800" fill="#0FA860" fillOpacity=".75">AN TOÀN &lt;=30%</text>
          <text x={CX}      y={CY + 18} textAnchor="middle" fontSize="8" fontFamily="Nunito, sans-serif" fontWeight="800" fill="#C48020" fillOpacity=".75">CẢNH BÁO 30-50%</text>
          <text x={CX + 82} y={CY + 18} textAnchor="middle" fontSize="8" fontFamily="Nunito, sans-serif" fontWeight="800" fill="#C82020" fillOpacity=".75">NGUY HIỂM &gt;50%</text>
        ...
        <div className="gauge-meta">
          <div className="gauge-stat">
            ...
            <span className="gauge-stat-val">30% / 50%</span>
          </div>
