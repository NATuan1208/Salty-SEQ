      ...
      <div style={{ display:'flex', height:'calc(100vh - 50px)', overflow:'hidden' }}>
        ...
        <div style={{
          ...
          <div style={{ display:'flex', flexDirection:'column', gap:'6px', marginBottom:'14px' }}>
            {[['#0FA860','Thấp (<= 30%)', 'Nguy cơ thấp, cây khỏe'],
              ['#C48020','Vừa (30–50%)', 'Theo dõi thường xuyên'],
              ['#C82020','Cao (> 50%)', 'Cần can thiệp gấp']].map(([c,l,d]) => (
        ...
        <div style={{ padding:'28px 36px', maxWidth:'1100px', margin:'0 auto' }}>
          ...
          <div style={{ marginBottom:'32px' }}>
            ...
            <div style={{
              ...
              <span><strong style={{ color:'var(--ink-2)' }}>Ngưỡng rủi ro:</strong> Cảnh báo &gt;30% · Nguy hiểm &gt;50%</span>
