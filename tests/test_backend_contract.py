...
DEMO_DIR = Path(__file__).resolve().parents[1] / "saltyseq-demo"
sys.path.insert(0, str(DEMO_DIR))

from backend import inference  # noqa: E402
from backend.main import PredictRequest, api_predict  # noqa: E402
...
class FrontendSyncTests(unittest.TestCase):
    def test_frontend_uses_inclusive_threshold_boundaries(self):
        files = [
            Path("saltyseq-demo/frontend/js/ui/prediction.js"),
            Path("saltyseq-demo/frontend/js/ui/map-panel.js"),
            Path("saltyseq-demo/frontend/js/ui/pages.js"),
            Path("saltyseq-demo/frontend/js/ui/recommendations-page.js"),
        ]
        for path in files:
